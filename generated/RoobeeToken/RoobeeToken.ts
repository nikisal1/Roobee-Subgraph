...
export class RoobeeToken extends ethereum.SmartContract {
  static bind(address: Address): RoobeeToken {
    return new RoobeeToken("RoobeeToken", address);
  }
  ...
  approveAndCall(
    ...
    let result = super.call(
      "approveAndCall",
      "approveAndCall(address,uint256,string):(bool)",
      [
        ethereum.Value.fromAddress(_spender),
        ethereum.Value.fromUnsignedBigInt(_value),
        ethereum.Value.fromString(_extraData)
      ]
    );
  ...
  getAvailableBalance(from: Address): BigInt {
    let result = super.call(
      "getAvailableBalance",
  ...
  try_getAvailableBalance(from: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall(
      "getAvailableBalance",
      "getAvailableBalance(address):(uint256)",
      [ethereum.Value.fromAddress(from)]
  ...
  freezeFor(owner: Address): BigInt {
    let result = super.call("freezeFor", "freezeFor(address):(uint256)", [
      ethereum.Value.fromAddress(owner)
    ]);
  ...
  try_freezeFor(owner: Address): ethereum.CallResult<BigInt> {
    let result = super.tryCall("freezeFor", "freezeFor(address):(uint256)", [
      ethereum.Value.fromAddress(owner)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  try_freezeOf(owner: Address): ethereum.CallResult<BigInt> {
  ...
  mintWithFreeze(
    _to: Address,
    _value: BigInt,
    _unfreezeTimestamp: BigInt,
    _subsequentUnlock: boolean
  ): boolean {
    let result = super.call(
      "mintWithFreeze",
      "mintWithFreeze(address,uint256,uint256,bool):(bool)",
      [
        ethereum.Value.fromAddress(_to),
        ethereum.Value.fromUnsignedBigInt(_value),
        ethereum.Value.fromUnsignedBigInt(_unfreezeTimestamp),
        ethereum.Value.fromBoolean(_subsequentUnlock)
      ]
    );
...
export class MintWithFreezeCall extends ethereum.Call {
  get inputs(): MintWithFreezeCall__Inputs {
    return new MintWithFreezeCall__Inputs(this);
  }

  get outputs(): MintWithFreezeCall__Outputs {
    return new MintWithFreezeCall__Outputs(this);
  }
}

export class MintWithFreezeCall__Inputs {
  _call: MintWithFreezeCall;

  constructor(call: MintWithFreezeCall) {
    this._call = call;
  }
  ...
  get _unfreezeTimestamp(): BigInt {
    return this._call.inputValues[2].value.toBigInt();
  }

  get _subsequentUnlock(): boolean {
    return this._call.inputValues[3].value.toBoolean();
  }
}

export class MintWithFreezeCall__Outputs {
  _call: MintWithFreezeCall;
